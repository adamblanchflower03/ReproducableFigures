...
#loading save diagnostic as png function
source(here("functions", "save_diagnostic_plot_as_png.R"))

#loading save diagnostic as svg function
source(here("functions", "save_diagnostic_plot_as_svg.R"))

#loading linear model figure function
source(here("functions", "linear_model_figure.R"))

#loading save results figure as png function
source(here("functions", "save_results_figure_as_png.R"))

#loading save results figure as png function 
source(here("functions", "save_results_figure_as_svg.R"))
```
