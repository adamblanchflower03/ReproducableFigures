...
Before performing a linear model analysis it is important to check that the Gentoo body mass data meets it's assumptions of: 1) independence 2) normality 3) homoscedasticity and 4) no influential outliers. I do not have access to the methods used to collect the body mass data but for the purpose of this analysis I have assumed that each data point is independent of each other.

To do this I have used a mulit-panel grid of diagnostic plots below. The Q-Q residuals plot shows that the data points closely follow the straight line suggesting that the residuals are normally distributed.
